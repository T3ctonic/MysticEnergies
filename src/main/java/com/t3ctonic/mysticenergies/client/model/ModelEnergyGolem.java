package com.t3ctonic.mysticenergies.client.model;
...
public class ModelEnergyGolem extends ModelBase {
    ...
    public ModelEnergyGolem() {
        this(0.0F);
    }

    public ModelEnergyGolem(float par1) {
        this(par1, -7.0F);
    }

    public ModelEnergyGolem(float par1, float par2) {
        short short1 = 128;
        short short2 = 128;
